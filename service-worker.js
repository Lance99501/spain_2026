const CACHE_VERSION='spain2026-20260927-v67';
...
const APP_SHELL=[
  ...
  './assets/css/demo.css',
  './assets/css/today.css?v=60',
  './assets/css/map.css',
  './assets/css/place-language.css',
  './assets/css/itinerary.css?v=58',
  ...
  './assets/js/map.js?v=57',
  './assets/js/city-groups.js?v=57',
  './assets/js/place-language.js',
  './assets/js/place-labels.js',
  './assets/js/ticket.js',
  './assets/js/itinerary.js?v=59',
  './assets/js/today.js?v=61',
  './assets/js/pwa.js',
